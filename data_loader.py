...
class CASIAData(data.Dataset):
    def __init__(self, data_dir, trial, transform=None, colorIndex = None, thermalIndex = None):
        
        train_color_list = data_dir + 'protocols_addlabel/vis_train_{}'.format(trial) + '.txt'
        train_thermal_list = data_dir + 'protocols_addlabel/nir_train_{}'.format(trial) + '.txt'
